...
\end{proof}
\begin{remarque} [Extension de Tietze] Si $f$ uniformément continue sur $A\subset X$ quelconque, on a toujours une extension à priori pas unique. On peut supposer(on peut supposer) $w$ croissant et sous additif. $F(x):=\inf_{y\in A}f(y)w(d(x,y))$
\end{remarque}
\begin{remarque}
